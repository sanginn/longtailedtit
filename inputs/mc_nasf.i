...
[Functions]
  [./sig_ini_v]
    type = ParsedFunction
    value = 20.0*y # initial stress that should result from the weight force
  [../]
  [./sig_ini_h]
    type = ParsedFunction
    value = 10.0*y # some arbitrary xx and yy stress that should not affect the result
  [../]
  [./disp_footing]
    type = ParsedFunction
    value = -0.01*t
