...
/****************************************************************/
#ifndef FINITESTRAINMOHRCOULOMB2_H
#define FINITESTRAINMOHRCOULOMB2_H

#include "FiniteStrainPlasticBase2.h"

class FiniteStrainMohrCoulomb2;
 ...
 */
class FiniteStrainMohrCoulomb2 : public FiniteStrainPlasticBase2
{
public:
  FiniteStrainMohrCoulomb2(const InputParameters & parameters);
