...
/****************************************************************/
#ifndef FINITESTRAINPLASTICBASE2
#define FINITESTRAINPLASTICBASE2

#include "FiniteStrainMaterial.h"

class FiniteStrainPlasticBase2;
 ...
 */
class FiniteStrainPlasticBase2 : public FiniteStrainMaterial
{
public:
  FiniteStrainPlasticBase2(const InputParameters & parameters);
