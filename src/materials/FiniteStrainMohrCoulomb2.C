...
template<>
InputParameters validParams<FiniteStrainMohrCoulomb2>()
{
...
FiniteStrainMohrCoulomb2::FiniteStrainMohrCoulomb2(const InputParameters & parameters) :
...
void FiniteStrainMohrCoulomb2::initQpStatefulProperties()
{
  _mc_internal[_qp] = 0;
...
void
FiniteStrainMohrCoulomb2::postReturnMap()
{
...
unsigned int
FiniteStrainMohrCoulomb2::numberOfInternalParameters()
{
  return 1;
}

void
FiniteStrainMohrCoulomb2::yieldFunction(const RankTwoTensor &stress, const std::vector<Real> & intnl, std::vector<Real> & f)
{
...
RankTwoTensor
FiniteStrainMohrCoulomb2::df_dsig(const RankTwoTensor & stress, const Real sin_angle)
{
  Real mean_stress = stress.trace()/3.0;
...
void
FiniteStrainMohrCoulomb2::dyieldFunction_dstress(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<RankTwoTensor> & df_dstress)
{
  Real sinphi = std::sin(phi(intnl[0]));
...
void
FiniteStrainMohrCoulomb2::dyieldFunction_dintnl(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<std::vector<Real> > & df_dintnl)
{
  df_dintnl.resize(1);
...
void
FiniteStrainMohrCoulomb2::flowPotential(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<RankTwoTensor> & r)
{
...
void
FiniteStrainMohrCoulomb2::dflowPotential_dstress(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<RankFourTensor> & dr_dstress)
{
...
void
FiniteStrainMohrCoulomb2::dflowPotential_dintnl(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<std::vector<RankTwoTensor> > & dr_dintnl)
{
  dr_dintnl.resize(1);
...
void
FiniteStrainMohrCoulomb2::hardPotential(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<Real> > & h)
{
  h.resize(1);
  h[0].assign(1, -1.0);
}
...
void
FiniteStrainMohrCoulomb2::dhardPotential_dstress(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<RankTwoTensor> > & dh_dstress)
{
  dh_dstress.resize(1);
...
void
FiniteStrainMohrCoulomb2::dhardPotential_dintnl(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<std::vector<Real> > > & dh_dintnl)
{
  dh_dintnl.resize(1);
...
void
FiniteStrainMohrCoulomb2::abbo(const Real sin3lode, const Real sin_angle, Real & aaa, Real & bbb, Real & ccc)
{
...
void
FiniteStrainMohrCoulomb2::dabbo(const Real sin3lode, const Real /*sin_angle*/, Real & daaa, Real & dbbb, Real & dccc)
{
