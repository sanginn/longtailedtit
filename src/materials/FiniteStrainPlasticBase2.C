...
template<>
InputParameters validParams<FiniteStrainPlasticBase2>()
{
...
FiniteStrainPlasticBase2::FiniteStrainPlasticBase2(const InputParameters & parameters) :
...
void
FiniteStrainPlasticBase2::computeQpStress()
{
  if (_fspb_debug == 3)
  {
    checkJacobian();
  ...
  if (!return_successful)
  {
    ...
    //Move back to old values
    _elastic_strain[_qp] = _elastic_strain_old[_qp];
...
void
FiniteStrainPlasticBase2::preReturnMap()
{
}

void
FiniteStrainPlasticBase2::postReturnMap()
{
}

unsigned int
FiniteStrainPlasticBase2::numberOfYieldFunctions()
{
  return 1; // one yield function
}

unsigned int
FiniteStrainPlasticBase2::numberOfInternalParameters()
{
  return 0; // no internal parameters
}

void
FiniteStrainPlasticBase2::yieldFunction(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<Real> & f)
{
  f.assign(1, 1.0); // one yield function, with the value 1.0
}

void
FiniteStrainPlasticBase2::dyieldFunction_dstress(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<RankTwoTensor> & df_dstress)
{
...
void
FiniteStrainPlasticBase2::dyieldFunction_dintnl(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<Real> > & df_dintnl)
{
...
void
FiniteStrainPlasticBase2::flowPotential(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<RankTwoTensor> & r)
{
  r.resize(1, RankTwoTensor()); // zero flow potential (zero comes from RankTwoTensor initialization)
}

void
FiniteStrainPlasticBase2::dflowPotential_dstress(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<RankFourTensor> & dr_dstress)
{
  dr_dstress.resize(1, RankFourTensor()); // zero derivative (zero comes from RankFourTensor intialization)
}

void
FiniteStrainPlasticBase2::dflowPotential_dintnl(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<RankTwoTensor> > & dr_dintnl)
{
  dr_dintnl.resize(0); // zero internal parameters (ie perfect plasticity)
}

void
FiniteStrainPlasticBase2::hardPotential(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<Real> > & h)
{
  h.resize(0); // zero internal parameters mean zero hardening potentials
}

void
FiniteStrainPlasticBase2::dhardPotential_dstress(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<RankTwoTensor> > & dh_dstress)
{
  dh_dstress.resize(0); // zero internal parameters mean zero hardening potentials
}

void
FiniteStrainPlasticBase2::dhardPotential_dintnl(const RankTwoTensor & /*stress*/, const std::vector<Real> & /*intnl*/, std::vector<std::vector<std::vector<Real> > > & dh_dintnl)
{
  dh_dintnl.resize(0); // zero internal parameters mean zero hardening potentials
}

bool
FiniteStrainPlasticBase2::returnMap(const RankTwoTensor & stress_old, const RankTwoTensor & plastic_strain_old, const std::vector<Real> & intnl_old, const RankTwoTensor & delta_d, const RankFourTensor & E_ijkl, RankTwoTensor & stress, RankTwoTensor & plastic_strain, std::vector<Real> & intnl, std::vector<Real> & f, unsigned int & iter)
{
...
void
FiniteStrainPlasticBase2::calculateConstraints(const RankTwoTensor & stress, const std::vector<Real> & intnl_old, const std::vector<Real> & intnl, const std::vector<Real> & pm, const RankTwoTensor & delta_dp, std::vector<Real> & f, RankTwoTensor & epp, std::vector<Real> & ic)
{
  // yield functions
  yieldFunction(stress, intnl, f);
...
void
FiniteStrainPlasticBase2::calculateRHS(const RankTwoTensor & stress, const std::vector<Real> & intnl_old, const std::vector<Real> & intnl, const std::vector<Real> & pm, const RankTwoTensor & delta_dp, std::vector<Real> & rhs)
{
...
Real
FiniteStrainPlasticBase2::residual2(const std::vector<Real> & f, const RankTwoTensor & epp, const std::vector<Real> & ic)
{
  Real nr_res2 = 0;
...
void
FiniteStrainPlasticBase2::calculateJacobian(const RankTwoTensor & stress, const std::vector<Real> & intnl, const std::vector<Real> & pm, const RankFourTensor & E_inv, std::vector<std::vector<Real> > & jac)
{
...
void
FiniteStrainPlasticBase2::nrStep(const RankTwoTensor & stress, const std::vector<Real> & intnl_old, const std::vector<Real> & intnl, const std::vector<Real> & pm, const RankFourTensor & E_inv, const RankTwoTensor & delta_dp, RankTwoTensor & dstress, std::vector<Real> & dpm, std::vector<Real> & dintnl)
{
...
void
FiniteStrainPlasticBase2::checkDerivatives()
{
...
void
FiniteStrainPlasticBase2::fddyieldFunction_dstress(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<RankTwoTensor> & df_dstress)
{
...
void
FiniteStrainPlasticBase2::fddflowPotential_dstress(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<RankFourTensor> & dr_dstress)
{
...
void
FiniteStrainPlasticBase2::fddflowPotential_dintnl(const RankTwoTensor & stress, const std::vector<Real> & intnl, std::vector<std::vector<RankTwoTensor> > & dr_dintnl)
{
...
void
FiniteStrainPlasticBase2::checkJacobian()
{
...
void
FiniteStrainPlasticBase2::fdJacobian(const RankTwoTensor & stress, const std::vector<Real> & intnl_old, const std::vector<Real> & intnl, const std::vector<Real> & pm, const RankTwoTensor & delta_dp, const RankFourTensor & E_inv, std::vector<std::vector<Real> > & jac)
{
...
void
FiniteStrainPlasticBase2::outputAndCheckDebugParameters()
{
  _console << "stress = \n";
